...
for(const name of ['fachada.jpg','lateral.jpg','planta-original.png','violonista.webp','violonista-acorde.webp','violonista-canto.webp'])copyFileSync(resolve(root,'public',name),resolve(root,name));
